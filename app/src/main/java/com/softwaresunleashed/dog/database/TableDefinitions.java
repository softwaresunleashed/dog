...
public class TableDefinitions {
    ...
    public static int REGISTERS_DETAILID = 2;
    public static int REGISTERS_NAME = 3;
    public static int REGISTERS_SIZE = 4;
    ...
    // Table - RegDetails
    public static int REGDETAILS_DETAILID = 0;
    public static int REGDETAILS_NAME = 1;
