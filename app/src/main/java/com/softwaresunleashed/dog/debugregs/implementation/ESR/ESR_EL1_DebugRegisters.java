...
public class ESR_EL1_DebugRegisters extends DebugRegisters {
    ...
    private String regDesc = "<BIT_FIELD>" +
            ...
            "        <VALID_VALUE VAL=\"40\" VAL_MEANING=\"Trapped floating-point exception taken from AArch32 state\" />" +
            ...
            "        <VALID_VALUE VAL=\"48\" VAL_MEANING=\"Breakpoint exception from a lower Exception level\" />" +
            "        <VALID_VALUE VAL=\"49\" VAL_MEANING=\"Breakpoint exception taken without a change in Exception level\" />" +
            "        <VALID_VALUE VAL=\"50\" VAL_MEANING=\"Software Step exception from a lower Exception level\" />" +
            "        <VALID_VALUE VAL=\"51\" VAL_MEANING=\"Software Step exception taken without a change in Exception level\" />" +
